...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo $base_url?>server/login_process.php" method="post">
      ...
      <p class="mb-0">
        <a href="<?php echo $base_url?>auth/register.php" class="text-center">Register a new membership</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
